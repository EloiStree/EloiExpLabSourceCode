...
public class XInputToBooleanMono : MonoBehaviour
{
    ...
    public INamedBooleanUnityEventGet m_namedBooleanChanged;
    ...
    public void RefreshHardwareInfo() {
        ...
        for (int y = 0; y < m_player.Length; y++)
        {
            ...
            for (int i = 0; i < player.m_boolObserved.Count; i++)
            {
                ...
                StructNamedBoolean value = new StructNamedBoolean(player.m_boolObserved[i].m_name, player.m_boolObserved[i].m_debugValue);
                m_namedBooleanChanged.Invoke( value );
            }
            for (int i = 0; i < player.m_floatObserved.Count; i++)
            {
                ...
                StructNamedBoolean value = new StructNamedBoolean(player.m_floatObserved[i].m_name, player.m_floatObserved[i].m_debugValue);
                m_namedBooleanChanged.Invoke(value);
            }
