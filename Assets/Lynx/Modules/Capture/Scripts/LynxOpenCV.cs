...
namespace Lynx
{
    public class LynxOpenCV
    {
        ...
        [DllImport(LIB_NAME)]
        public static extern void ResizeYUVFrame(int width, int height, int new_width, int new_height, IntPtr inBuffer, IntPtr outBuffer);

        [DllImport(LIB_NAME)]
        public static extern void ResizeYUVFrame(int width, int height, int new_width, int new_height, IntPtr inBuffer, byte[] outBuffer);
