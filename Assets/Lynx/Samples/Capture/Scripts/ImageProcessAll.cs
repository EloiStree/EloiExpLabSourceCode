    ...
    public class ImageProcessAll : ImageProcessBase
    {
        ...
        public override void StartVideoCapture()
        {
            ...
            if (m_enableRGB)
            {
                ...
                if (m_imageRawUI.Length > 0)
                    m_imageRawUI[0].texture = m_textures[0];
                if (m_imageRawUI.Length > 1)
                    m_imageRawUI[1].texture = m_textures[1];
                // Register callbacks
            ...
            if (m_enableTracking)
            {
                ...
                if (m_imageRawUI.Length > 2)
                    m_imageRawUI[2].texture = m_textures[2];
                if (m_imageRawUI.Length > 3)
                    m_imageRawUI[3].texture = m_textures[3];
                // Register callbacks
            ...
            if (m_enableHandtracking)
            {
                ...
                if (m_imageRawUI.Length > 4)
                    m_imageRawUI[4].texture = m_textures[4];
                if (m_imageRawUI.Length > 5)
                    m_imageRawUI[5].texture = m_textures[5];

                m_pushCreatedTexture.Invoke(4, m_textures[4]);
                m_pushCreatedTexture.Invoke(5, m_textures[4]);
                // Register callbacks
        ...
        public TextureCreatedEvent m_pushCreatedTexture = new();
        [System.Serializable]
        public class TextureCreatedEvent : UnityEvent<int, Texture2D> { }
    }
